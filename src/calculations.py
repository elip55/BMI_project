...
from .intro import goal_weight, goal_BMI
import csv
...
def calculations(): 
    ...
    if weight > goal_weight: 
        print("-------------------")
        print(bcolors.FAIL + f"\n You haven't reached your weight goal of {goal_weight}." + bcolors.ENDC)
        print("-------------------")
    elif weight <= goal_weight:
        print("-------------------")
        print(bcolors.OKBLUE + f"\n Congrats!  You have reached your weight goal of {goal_weight}!" + bcolors.ENDC)
        print("-------------------")
    ...
    if csv_option == 'y' or csv_option == ' y':
        header = ' , WEIGHT, BMI \n'
        data = f'LOW, , {healthy_BMI_min} \n HIGH, , {healthy_BMI_max} \n GOAL, {goal_weight}, {goal_BMI} \n ACTUAL, {weight}, {BMI}'
